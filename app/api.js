...
function addOptions(defaults, url) {
  ...
  if(defaults.method != 'get' || url.includes('schedules'))
...
Api.schedules = function(id) {
  // company/{id}/schedules/?id={id}&r=con&f=cashflow&q=Cash+from+Investing+Activity
  return {
    ...
    params: {
      ...
      r: 'con',
      f: 'cashflow',
      q: 'Cash from Investing Activity'
    }
  };
};
